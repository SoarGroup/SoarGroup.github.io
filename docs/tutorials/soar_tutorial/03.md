{{tutorial_wip_warning("Soar.Tutorial.Part.3.-.Subgoals.pdf
")}}
...
You should use [VisualSoar][VSIDE] in developing your tank. The release includes
...
This rule is always created by [VisualSoar][VSIDE] and is in the default set of
