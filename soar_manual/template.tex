...
\usepackage{caption}            % needed for \LTcaptype in uncaptioned longtables (pandoc >=3.x)
\newcounter{none}               % pandoc 3.x emits \def\LTcaptype{none}; longtable needs the counter to exist
\usepackage{amsmath}
\usepackage{booktabs}
\usepackage{float}
...
\newcommand{\SoarVersionRevision}{5}
...
$else$
  \usepackage{unicode-math} % this also loads fontspec
  % Safety net: if any Unicode math glyph leaks into a text-mode context
  % (e.g. a heading's TOC entry where lualatex can't switch to math mode),
  % map it back to an ensuremath math command so the math font
  % provides the glyph. Without this, warnings like "Missing character
  % U+1D706 in font rm-lmr12" can appear for headings containing math lambda.
  ...
  \newunicodechar{𝑊}{\ensuremath{W}}
  \newunicodechar{𝑎}{\ensuremath{a}}
  \newunicodechar{𝑏}{\ensuremath{b}}
  \newunicodechar{𝑐}{\ensuremath{c}}
  \newunicodechar{𝑑}{\ensuremath{d}}
  \newunicodechar{𝑒}{\ensuremath{e}}
  \newunicodechar{𝑖}{\ensuremath{i}}
  \newunicodechar{𝑘}{\ensuremath{k}}
  \newunicodechar{𝑙}{\ensuremath{l}}
  \newunicodechar{𝑛}{\ensuremath{n}}
  \newunicodechar{𝑜}{\ensuremath{o}}
  \newunicodechar{𝑟}{\ensuremath{r}}
  \newunicodechar{𝑠}{\ensuremath{s}}
  \newunicodechar{𝑡}{\ensuremath{t}}
  \newunicodechar{𝑢}{\ensuremath{u}}
  \newunicodechar{𝑣}{\ensuremath{v}}
  \newunicodechar{𝑤}{\ensuremath{w}}
...
% Only load lmodern Type1 fonts under pdflatex. Under lualatex/xelatex
% we use unicode-math + latinmodern-math via the iftex branch above.
% Loading lmodern unconditionally here would clobber the unicode-math
% setup and cause Unicode math glyphs (e.g. U+1D706 lambda) to be
% requested from the Type1 text font, which doesn't contain them.
\ifPDFTeX
\usepackage{lmodern}
\fi
$endif$
